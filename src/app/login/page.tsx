  ...
  return (
    <main className="h-screen grid grid-cols-2 relative">
      <div className="relative w-full flex flex-col bg-muted p-10 text-primary-foreground">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;Fotonova AI revolutionized my workflow! I can now create stunning,
              professional-grade images in minutes, saving both time and effort
              without compromising quality.&rdquo;
            </p>
      ...
      <div className="relative flex flex-col items-center justify-center p-8 h-full ">
        <div className="w-[350px] mx-auto max-w-xl w-full">
        <AuthForm/>
        </div>
      </div>
    </main>
